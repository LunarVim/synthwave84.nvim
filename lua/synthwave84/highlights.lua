...
theme.set_highlights = function(cfg)
  ...
  hl(0, "@const.builtin", { link = 'Constant' })
  ...
  hl(0, "@punct.bracket", { link = 'Delimiter' })
  ...
  hl(0, "@stringSpecial", { fg = c.fg, bg = 'NONE' })
  hl(0, "@environmentName", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@variableBuiltin", { fg = c.red, bg = 'NONE' })
  ...
  hl(0, "@parameter.reference", { link = 'Variable' })
