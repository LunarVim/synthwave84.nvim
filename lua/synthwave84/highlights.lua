...
theme.set_highlights = function(cfg)
  ...
  hl(0, "Keyword", { fg = c.yellow, bg = '#312c37', bold=cfg.keyword })
  ...
  hl(0, "@string.regex", { link = 'TSString' })
  hl(0, "@string.escape", { link = 'TSString' })
  hl(0, "@character", { link = 'TSString' })
  hl(0, "@character.special", { link = 'TSSpecialChar' })
  hl(0, "@number", { link = 'TSNumber' })
  hl(0, "@float", { link = 'TSFloat' })
  hl(0, "@boolean", { link = 'TSBoolean' })
  hl(0, "@constant", { link = 'TSConstant' })
  hl(0, "@const.builtin", { link = 'TSConstant' })
  hl(0, "@constructor", { link = 'TSType' })
  ...
  hl(0, "@keyword.operator", { link = 'TSKeyword' })
  hl(0, "@keyword.function", { link = 'TSKeywordFunction' })
  hl(0, "@function", { link = 'TSFunction' })
  hl(0, "@func.builtin", { link = 'TSFunction' })
  hl(0, "@method", { link = 'TSFunction' })
  hl(0, "@func.macro", { link = 'TSFunction' })
  hl(0, "@conditional", { link = 'TSConditional' })
  hl(0, "@repeat", { link = 'TSRepeat' })
  hl(0, "@operator", { link = 'TSOperator' })
  hl(0, "@pre.proc", { link = 'TSPreProc' })
  hl(0, "@storage.class", { link = 'TSStorageClass' })
  hl(0, "@structure", { link = 'TSStructure' })
  hl(0, "@type.definition", { link = 'TSTypedef' })
  hl(0, "@define", { link = 'TSDefine' })
  hl(0, "@note", { link = 'TSComment' })
  hl(0, "@todo", { link = 'TSTodo' })
  hl(0, "@debug", { link = 'TSDebug' })
  hl(0, "@danger", { link = 'TSError' })
  hl(0, "@title", { link = 'TSTitle' })
  hl(0, "@label", { link = 'TSLabel' })
  hl(0, "@punct.delimiter", { link = 'TSDelimiter' })
  hl(0, "@tag.delimiter", { link = 'TSTagDelimiter' })
  hl(0, "@punct.bracket", { link = 'TSDelimiter' })
  hl(0, "@punct.special", { link = 'TSDelimiter' })
  hl(0, "@tag", { link = 'TSTag' })
  hl(0, "@strong", { link = 'TSStrong' })
  hl(0, "@emphasis", { link = 'TSEmphasis' })
  hl(0, "@underline", { link = 'TSUnderline' })
  hl(0, "@strike", { link = 'TSStrike' })
  hl(0, "@string.special", { link = 'TSStringSpecial' })
  hl(0, "@environment.name", { link = 'TSEnvironmentName' })
  hl(0, "@variable.builtin", { link = 'TSVariableBuiltin' })
  hl(0, "@const.macro", { link = 'TSConstBuiltin' })
  ...
  hl(0, "@parameter", { link = 'TSVariable' })
  hl(0, "@parameter.reference", { link = 'TSVariable' })
  hl(0, "@attribute", { link = 'TSVariable' })
  hl(0, "@text", { link = 'TSText' })
  hl(0, "@attribute", { link = 'TSAttribute' })
  hl(0, "@error", { link = 'TSError' })
  hl(0, "@warning", { link = 'TSWarning' })
  hl(0, "@query.linter.error", { link = 'TSQueryLinterError' })
  hl(0, "@text.uri", { link = 'TSURI' })
  hl(0, "@math", { link = 'TSMath' })
  hl(0, "@literal", { link = 'TSLiteral' })
  ...
  -- Coc.nvim
  hl(0, "CocHoverRange", { link = 'HopPreview' })
  hl(0, "CocSearch", { link = 'Search' })
  hl(0, "CocPumSearch", { link = 'Search' })
  hl(0, "CocMarkdownHeader", { link = 'TSProperty' })
  hl(0, "CocMarkdownLink", { link = 'Search' })
  hl(0, "CocMarkdownCode", { link = 'TSConstant' })
  hl(0, "CocPumShortcut", { link = 'CmpItemKindMethod' })
  hl(0, "CocPumVirtualText", { link = 'CmpItemAbbrDeprecated' })
  hl(0, "CocPumMenu", { link = 'CmpItemKindClass' })
  hl(0, "CocMenuSel", { link = 'CmpItemAbbrMatch' })
  hl(0, "CocDisabled", { link = 'LspDiagnosticsVirtualTextWarning' })
  hl(0, "CocSnippetVisual", { link = 'LspDiagnosticsDefaultInformation' })
  hl(0, "CocInlayHint", { link = 'LspDiagnosticsHint' })
  hl(0, "CocNotificationProgress", { link = 'LspDiagnosticsInfo' })
  hl(0, "CocNotificationButton", { link = 'LspDiagnosticsInfo' })
  hl(0, "CocSemClass", { link = 'TSStorageClass' })
  hl(0, "CocSemEnum", { link = 'TSType' })
  hl(0, "CocSemInterface", { link = 'TSType' })
  hl(0, "CocSemStruct", { link = 'TSStructure' })
  hl(0, "CocSemTypeParameter", { link = 'TSTypeDefinition' })
  hl(0, "CocSemVariable", { link = 'TSVariable' })
  hl(0, "CocSemEnumMember", { link = 'TSEnvironmentName' })
  hl(0, "CocInfoLine", { link = 'CmpItemKindProperty' })
  hl(0, "CocHintLine", { link = 'CmpItemKindKeyword' })
  hl(0, "CocCodeLens", { link = 'LspCodeLens' })
  hl(0, "CocFadeOut", { link = 'LspDiagnosticsDefaultHint' })
  hl(0, "CocStrikeThrough", { link = 'LspDiagnosticsInfo' })
  hl(0, "CocListMode", { link = 'CmpItemKindEvent' })
  hl(0, "CocListPath", { link = 'CmpItemKindFolder' })
  hl(0, "CocSelectedText", { link = 'CmpItemAbbrMatch' })
  hl(0, "CocListsLine", { link = 'CmpItemKindReference' })
  hl(0, "CocListsDesc", { link = 'CmpItemKindField' })
  hl(0, "HighlightedyankRegion", { link = 'CmpItemAbbrMatch' })
  hl(0, "CocGitAddedSign", { link = 'GitSignsAdd' })
  hl(0, "CocGitChangeRemovedSign", { link = 'GitSignsChange' })
  hl(0, "CocGitChangedSign", { link = 'GitSignsChange' })
  hl(0, "CocGitRemovedSign", { link = 'GitSignsDelete' })
  hl(0, "CocGitTopRemovedSign", { link = 'GitSignsDelete' })
end
