...
theme.set_highlights = function(cfg)
  ...
  hl(0, "@keyword.function", { fg = c.green, bg = 'NONE' })
  ...
  hl(0, "@text.underline", { link = 'Underline' })
  ...
  hl(0, "@text.environment.name", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@text.todo", { link = 'Todo' })
  hl(0, "@text.note", { link = 'Comment' })
  hl(0, "@text.warning", { fg = c.warn, bg = 'NONE' })
  hl(0, "@text.danger", { link = 'Error' })

  -- TreesitterTags
  hl(0, "@tag", { link = 'Tag' })
  hl(0, "@tag.attribute", { fg = c.yellow, bg = 'NONE', italic=true, })
  hl(0, "@tag.delimiter", { fg = c.blue, bg = 'NONE' })
